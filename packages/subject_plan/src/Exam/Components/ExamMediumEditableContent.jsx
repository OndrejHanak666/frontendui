...
export const ExamMediumEditableContent = ({exam, onChange=(e)=>null, onBlur=(e)=>null, children}) => {
    return (
        <>           
            <Input id={"minScore"} label={"Minimální počet bodů"} className="form-control" type="number" defaultValue={exam?.minScore|| "Minimální počet bodů"} onChange={onChange} onBlur={onBlur} />
            <Input id={"maxScore"} label={"Maximální počet bodů"} className="form-control"  type = "number" defaultValue={exam?.maxScore|| "Maximální počet bodů"} onChange={onChange} onBlur={onBlur} />
